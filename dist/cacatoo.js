...
class Simulation {
    ...
    */
    createFlockDisplay(name, config = {}) {
        ...
        else if(config.fill == "rainbow") this.colourGradientArray(num_colours, 0,[251, 169, 73], [250, 228, 66], [139, 212, 72], [42, 168, 242],[50,100,255]);
        else if(config.fill == "pride") this.colourGradientArray(num_colours, 0,[228, 3, 3], [255, 140, 0], [255, 237, 0], [0, 128, 38], [0,76,255],[115,41,130]); 
